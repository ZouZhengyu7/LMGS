...
def camTodatabase(txtfile):
    ...
    parser.add_argument("--database_path", default="/home/zzy/zzy/scannet/scans/scene0070_00/database.db")
    ...
    for i, row in enumerate(rows):
        camera_id = db.update_camera(cameraModel, width, height, params, i+1)
...
if __name__ == "__main__":
    camTodatabase("/home/zzy/zzy/scannet/scans/scene0070_00/sparse/cameras.txt")